...
import static com.example.cyber_net.catalogmovie2.utils.Server.UP_COMMING;
...
public class UpComming extends Fragment {
    ...
    private void getData() {
        ...
        progressDialog.show();
        StringRequest request = new StringRequest(Request.Method.POST, UP_COMMING, new Response.Listener<String>() {
            @Override
